# Google Chrome Portable Enhanced
...
采用GitHub Actions自动编译发布, 下载地址:

[GC-Dev-Portable](https://nightly.link/KingLou4329/GC-Dev-Portable/workflows/build/main)
...
Chrome dev每周发布一次新版本, 定时为每两周 周三早八拉取构建新版本
